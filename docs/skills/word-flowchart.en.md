...
- “Use word-flowchart to convert the following research workflow into a Word-style flowchart, with black/white styling, orthogonal edges, strict alignment, and output DOT + image.”
- “Use word-flowchart to convert the following Mermaid flowchart into a Word-style flowchart and output DOT + image.”
